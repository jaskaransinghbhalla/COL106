...
public class COL106Dictionary<K, V> {
  ...
  COL106Dictionary(int hashTableSize) {
    ...
    hashTable =
      (LinkedList<HashTableEntry<K, V>>[]) Array.newInstance(
        LinkedList.class,
        hashTableSize
      );
  ...
  public void insert(K key, V value)
    throws KeyAlreadyExistException, NullKeyException {
    /*
  ...
  public int hash(K key) {
    /*
     * Input: A key of type K
     * Return: Returns the hash of the argumented key using the Polynomial Rolling Hash Function.
     */
