...
public class Poker {
  ...
  public Poker(int city_size, int[] players, int[] max_loss, int[] max_profit) {
    ...
    try {
      ...
      int zeroInitializer[] = new int[players.length];
      ...
      this.cityProfitHeap = new Heap(city_size, players, zeroInitializer);
      this.cityLossHeap = new Heap(city_size, players, zeroInitializer);
  ...
  public ArrayList<Integer> Play(int[] players, int[] bids, int winnerIdx) {
    ...
    try {
      ...
      System.out.println("Play Exited");
    } catch (Exception e) {}
  ...
  public void Enter(int player, int max_loss, int max_profit) {
    ...
    System.out.println("Enter Exited");
  }

  public ArrayList<Integer> nextPlayersToGetOut() {
    System.out.println("nextPlayersToGetOut Called");
    /* 
    ...
    System.out.println("nextPlayersToGetOut Exited");
    return citizens;
  }

  public ArrayList<Integer> playersInArena() {
    System.out.println("PlayersinArena Called");
    /* 
    ...
    System.out.println("PlayersinArena Exited");
    return citizens;
  }

  public ArrayList<Integer> maximumProfitablePlayers() {
    System.out.println("Maximum Profitable Players Called");
    /* 
    ...
    try {
      if (cityLossHeap.getMaxValue() == 0) {
        citizens = new ArrayList<Integer>(city_size);
      } else {
        citizens = cityProfitHeap.getMax();
      }
    } catch (Exception e) {}
    System.out.println("Maximum Profitable Players Exited");
    return citizens;
  }

  public ArrayList<Integer> maximumLossPlayers() {
    System.out.println("Maximum Loss Players Called");
    /* 
		   Returns id of citizens who has suffered maximum loss. 
			
		   Expected Time Complexity : O(1).
		*/
    ArrayList<Integer> citizens = new ArrayList<Integer>(city_size); // citizens with maximum loss.
    ...
    try {
      ...
      System.out.println("Maximum Loss Players Exited");
    } catch (Exception e) {}
    return citizens;
  }
}
