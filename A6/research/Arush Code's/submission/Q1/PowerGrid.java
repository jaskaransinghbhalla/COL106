...
public class PowerGrid {
  ...
  HashMap<String, Integer> grapher;
  HashMap<Integer, String> rgrapher;
  private HashMap<Integer, Integer> implines;
  private HashMap<String, Boolean> isBridge;
  Graph p;
  ...
  public PowerGrid(String filename) throws Exception {
    ...
    grapher = new HashMap<String, Integer>();
    rgrapher = new HashMap<Integer, String>();

    for (int i = 0; i < numLines; i++) {
      String[] line = br.readLine().split(" ");
      powerLines[i] = new PowerLine(line[0], line[1]);
      isBridge.put(line[0] + line[1], false);
      isBridge.put(line[1] + line[0], false);
